...
$MESSAGE['ADMIN']['INSUFFICIENT_PRIVELLIGES'] = 'Du har ikke de fornødne rettigheder til dette område';

$MESSAGE['LOGIN']['BOTH_BLANK'] = 'Indtast venligst dit brugernavn og din adgangskode nedenfor';
$MESSAGE['LOGIN']['USERNAME_BLANK'] = 'Vær venlig at indtaste et brugernavn';
$MESSAGE['LOGIN']['PASSWORD_BLANK'] = 'Vær venlig at indtaste en adgangskode ';
...
$MESSAGE['START']['INSTALL_DIR_EXISTS'] = 'ADVARSEL !!!  Installations mappen findes stadig på serveren. Slet den venligst omg. p.g.a sikkerhedsrisikoen !!';
$MESSAGE['START']['CURRENT_USER'] = 'Du er lige nu logget ind som :';

$MESSAGE['SETTINGS']['UNABLE_OPEN_CONFIG'] = 'Er ikke i stand til at åbne konfigurationsfilen';
...
$MESSAGE['SETTINGS']['MODE_SWITCH_WARNING'] = '<br>OBS: Ved at klikke på denne knap nulstilles alle IKKE gemte ændringer !!';
$MESSAGE['SETTINGS']['WORLD_WRITEABLE_WARNING'] = 'OBS !!!! : Dette anbefales KUN i testmiljøer på en lokal placering - IKKE offentligt';

$MESSAGE['USERS']['ADDED'] = 'Bruger blev tilføjet med succes !';
...
$MESSAGE['USERS']['PASSWORD_MISMATCH'] = 'De to adgangskoder du indtastede passer ikke sammen - de skal være ENS !';
...
$MESSAGE['USERS']['CHANGING_PASSWORD'] = 'OBS ! Du skal kun indtaste værdier i felterne ovenfor, såfremt du ønsker at ændre denne brugers adgangskode !';
$MESSAGE['USERS']['CONFIRM_DELETE'] = 'Er du HELT sikker på du vil slette den valgte bruger?';

$MESSAGE['GROUPS']['ADDED'] = 'Gruppe blev tilføjet med succes!';
...
$MESSAGE['GROUPS']['CONFIRM_DELETE'] = 'Er du HELT sikker på du vil slette denne gruppe (og alle brugere som findes i denne)?';
...
$MESSAGE['PREFERENCES']['CURRENT_PASSWORD_INCORRECT'] = 'Den (nuværende) adgangskode som du indtastede er ikke korrekt!';
$MESSAGE['PREFERENCES']['PASSWORD_CHANGED'] = 'Adgangskode ændret med succes!';

$MESSAGE['TEMPLATES']['CHANGE_TEMPLATE_NOTICE'] = 'OBS: For at ændre skabelonen skal du gå ind i sektionen med indstillinger!';

$MESSAGE['MEDIA']['DIR_DOT_DOT_SLASH'] = 'Kan ikke inkludere ../ i mappenavnet';
$MESSAGE['MEDIA']['DIR_DOES_NOT_EXIST'] = 'Mappen eksisterer ikke';
$MESSAGE['MEDIA']['TARGET_DOT_DOT_SLASH'] = 'Kan ikke have ../ i målet for biblioteket(mappen)';
...
$MESSAGE['MEDIA']['NONE_FOUND'] = 'Der blev ikke fundet nogle media i det pågældende bibliotek (mappe)';
...
$MESSAGE['MEDIA']['CONFIRM_DELETE'] = 'Er du sikker på du ønsker at slette flg. fil/bibliotek(Mappe)?';
...
$MESSAGE['MEDIA']['RENAMED'] = 'Omdøbning foretaget med succes!';
$MESSAGE['MEDIA']['CANNOT_RENAME'] = 'Omdøbning slog fejl !!';
...
$MESSAGE['PAGES']['ADDED'] = 'Side blev tilføjet systemet med succes!';
$MESSAGE['PAGES']['ADDED_HEADING'] = 'Overskrift til side blev tilføjet med succes!';
$MESSAGE['PAGES']['PAGE_EXISTS'] = 'Der findes allerede en side med dette eller lign. navn i forvejen!';
$MESSAGE['PAGES']['CANNOT_CREATE_ACCESS_FILE'] = 'Fejl under oprettelse af access fil i /pages biblioteket (Mappen) (utilstrækkelige rettigheder)';
$MESSAGE['PAGES']['CANNOT_DELETE_ACCESS_FILE'] = 'Fejl under sletning af access fil i /pages biblioteket  (utilstrækkelige privilegier)';
...
$MESSAGE['PAGES']['NOT_SAVED'] = 'Der opstod en fejl under forsøget på at gemme siden';
$MESSAGE['PAGES']['DELETE_CONFIRM'] = 'Er du sikker på du ønsker at slette den valgte side (og alle dens undersider)';
...
$MESSAGE['PAGES']['CANNOT_REORDER'] = 'Fejl ved forsøg på om-arrangering af side';
$MESSAGE['PAGES']['INSUFFICIENT_PERMISSIONS'] = 'Du har ikke rettigheder til at ændre denne side';
$MESSAGE['PAGES']['INTRO_NOT_WRITABLE'] = 'Kan ikke skrive til filen /pages/intro.php (utilstrækkelige privilegier)';
$MESSAGE['PAGES']['INTRO_SAVED'] = 'Intro Side blev gemt med succes!';
$MESSAGE['PAGES']['LAST_MODIFIED'] = 'Sidste ændring blev foretaget af :';
$MESSAGE['PAGES']['INTRO_LINK'] = 'Klik HER for at ændre din intro-side!';
$MESSAGE['PAGES']['SECTIONS_PROPERTIES_SAVED'] = 'Egenskaber for SEKTION blev ændret med succes!';
$MESSAGE['PAGES']['RETURN_TO_PAGES'] = 'Tilbage til sider';

$MESSAGE['GENERIC']['FILL_IN_ALL'] = 'Gå venligst tilbage og udfyld ALLE felter';
$MESSAGE['GENERIC']['FILE_TYPE'] = 'OBS: Vær venligst opmærksom på at den fil du vil uploade skal være i et af flg. formater:';
$MESSAGE['GENERIC']['FILE_TYPES'] = 'OBS: Vær venligst opmærksom på at den fil du vil uploade skal være i et af flg. formater:';
...
$MESSAGE['GENERIC']['BAD_PERMISSIONS'] = 'Kan ikke skrive til det valgte målbibliotek(Mappe)';
...
$MESSAGE['MOD_FORM']['EXCESS_SUBMISSIONS'] = 'Beklager ! Denne formular er blevet afsendt alt for mange gange indenfor den sidste time, og du vil derfor blive afvist - Prøv igen om en times tid!';
