...
$OVERVIEW['ADMINTOOLS'] = 'Accès aux Outils d&apos;administration de Website Baker...';
...
$TEXT['MODULE_ORDER'] = 'Priorité des modules lors de la recherche';
...
$MESSAGE['GENERIC']['CANNOT_UNINSTALL_IS_DEFAULT_TEMPLATE'] = "Le template <b>{{name}}</b> ne sait pas &ecirc;tre supprimŽ comme il s'agit d'un template standard!";
