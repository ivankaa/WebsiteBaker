...
$OVERVIEW['SETTINGS'] = 'Altere as configurações do Website Baker...';
...
$MESSAGE['SIGNUP']['NO_EMAIL'] = 'Você precisa informar um endereço de email';
...
$MESSAGE['FORGOT_PASS']['PASSWORD_RESET'] = 'Seu usuário e senha foram enviados para seu endereço de email';
$MESSAGE['FORGOT_PASS']['ALREADY_RESET'] = 'A senha não pode ser redefinida mais de uma vez por hora, desculpe';

$MESSAGE['START']['WELCOME_MESSAGE'] = 'Bem-Vindo à Administração do Website Baker';
$MESSAGE['START']['INSTALL_DIR_EXISTS'] = 'Aviso, O diretório "INSTALL" ainda existe!';
$MESSAGE['START']['CURRENT_USER'] = 'Você está logado como:';

$MESSAGE['SETTINGS']['UNABLE_OPEN_CONFIG'] = 'Não foi possivel abrir o arquivo de configuração';
$MESSAGE['SETTINGS']['UNABLE_WRITE_CONFIG'] = 'Não foi possivel gravar no aquivo de configuração';
$MESSAGE['SETTINGS']['SAVED'] = 'Alterações armazenadas com sucesso';
$MESSAGE['SETTINGS']['MODE_SWITCH_WARNING'] = 'Atenção: Pressionando esse botão, todas as alterações não salvas, serão perdidas';
$MESSAGE['SETTINGS']['WORLD_WRITEABLE_WARNING'] = 'Atenção: Somente recomendado para ambientes de teste';
...
$MESSAGE['USERS']['EMAIL_TAKEN'] = 'O endereço de email informado já está sendo utilizado';
$MESSAGE['USERS']['USERNAME_TAKEN'] = 'O usuário informado já está sendo utilizado';
$MESSAGE['USERS']['CHANGING_PASSWORD'] = 'Atenção: Você deve preencher os campos abaixo se deseja alterar a senha';
...
$MESSAGE['TEMPLATES']['CHANGE_TEMPLATE_NOTICE'] = 'Atenção: para alterar o tema (template) você precisa ir até a sessão Configurações';
...
$MESSAGE['PAGES']['ADDED_HEADING'] = 'Cabeçalho da Página adicionado com sucesso.';
...
$MESSAGE['PAGES']['SAVED_SETTINGS'] = 'Configurações de Página armazenadas com sucesso';
...
$MESSAGE['PAGES']['REORDERED'] = 'Re-ordenação feita com sucesso';
$MESSAGE['PAGES']['CANNOT_REORDER'] = 'Erro na re-ordenação da página';
...
$MESSAGE['PAGES']['INTRO_SAVED'] = 'Página de Introdução armazenada com sucesso';
$MESSAGE['PAGES']['LAST_MODIFIED'] = 'Última modificação por';
$MESSAGE['PAGES']['INTRO_LINK'] = 'Clique AQUI para modificar a Página de Introdução';
...
$MESSAGE['GENERIC']['WEBSITE_UNDER_CONSTRUCTION'] = 'Website Em Construção';
...
$MESSAGE['MOD_FORM']['INCORRECT_CAPTCHA'] = 'O Número de Verificação (conhecido como Captcha) que você entrou, é inválido. Se estiver tendo problemas usando o Captcha, envie uma mensagem para: '.SERVER_EMAIL;
