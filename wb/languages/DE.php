...
$TEXT['WBMAILER_DEFAULT_SETTINGS_NOTICE'] = 'Bitte gebe Standard "VON" Adresse und einen Senddernamen an. Als Absender Adresse empfiehlt sich ein Format wie: <strong>admin@DeineWebseite.de</strong>. Manche Email-Provider (z.B. <em>mail.de</em>) stellen keine Emails zu, die nicht &uuml;ber den Provider selbst verschickt wurden, in der Absenderadresse aber den Namen des Email-Providers <em>name@mail.de</em> enthalten. Die Standard Werte werden nur verwendet, wenn keine anderen Werte von Website Baker gesetzt wurden. Wenn Dein Service Provider <acronym title="Simple Mail Transfer Protocol">SMTP</acronym> anbietet, solltest Du diese Option f&uuml;r ausgehende Emails verwenden.';
$TEXT['WBMAILER_DEFAULT_SENDER_MAIL'] = 'Standard "VON" Adresse';
$TEXT['WBMAILER_DEFAULT_SENDER_NAME'] = 'Standard Absender Name';
$TEXT['WBMAILER_NOTICE'] = '<strong>SMTP Maileinstellungen:</strong><br />Die nachfolgenden Einstellungen m&uuml;ssen nur angepasst werden, wenn Du Email &uuml;ber <acronym title="Simple Mail Transfer Protocol">SMTP</acronym> verschicken willst. Wenn Du Deinen SMTP Server nicht kennst, oder Dir unsicher bei den Einstellungen bist, verwende einfach die Standard Emailroutine: PHP MAIL.';
$TEXT['WBMAILER_FUNCTION'] = 'Email Routine';
